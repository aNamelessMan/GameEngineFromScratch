// 仅仅-L告知路径，仍然会报错，必须-l明确告知需要链接哪个库，才不会报未定义的错误，链接器会自动根据xcb拼出libxcb.a
// clang -L/opt/homebrew/Cellar/libxcb/1.15/lib -lxcb
// -I/opt/homebrew/Cellar/libxcb/1.15/include -o helloengine_xcb
// helloengine_xcb.c

// clang -I /usr/X11/include/ -L /usr/X11/lib -o helloengine_opengl
// helloengine_opengl.cpp -lxcb -lX11 -lX11-xcb -lGL -lGLU
#include <GL/gl.h>
#include <GL/glu.h>
#include <GL/glx.h>
